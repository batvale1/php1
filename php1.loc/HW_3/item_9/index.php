...
function translateString($stringToTranslate)
{
    ...
    $stringToTranslate = implode($stringToTranslate);
    $stringToTranslate = preg_replace('/\s/','_', $stringToTranslate);
    $stringToTranslate = preg_replace('/\W/','', $stringToTranslate);

    return strtolower($stringToTranslate);
}
